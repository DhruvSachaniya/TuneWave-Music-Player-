        ...
        <>
            <div className="search-results">
                ...
                <div className="songs">
                    ...
                    {input_value && songresponse && songresponse.map((playlist) => (
                    <div className="librarysection-4" key={playlist.id}>
                        <div className="library-likedsongs">
                            <div>
                                <img src={`http://localhost:3333/uploads/music_photos/${encodeURIComponent(playlist.music_photo)}`} alt="liked_song" />
                            </div>
                            <div>
