  ...
  return (
    <div className="librarysection">
      <div className="librarysection-1">
        ...
        {isLoggedIn && isCreatePlaylistOpen && (
          <CreatePlaylistForm closeForm={closeCreatePlaylistForm} />
        )}
      </div>
      ...
      <div className="library-scroll">
        ...
        <div
          className="librarysection-4"
          onClick={() => {
            if (isLoggedIn) navigate("/likedsongs");
            else {
              toast.error("Login To Show Liked!");
            }
          }}
        >
        ...
        {isLoggedIn && isAccountWindowVisible && (
          <PlaylistRightClickWindow id={PlaylistId} />
        )}
      </div>
      <div className="librarysection-2">
        <p>🌐English</p>
