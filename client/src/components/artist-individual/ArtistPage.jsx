    ...
    useEffect(() => {
        async function fetchartistdata() {
            try {
                ...
                setartistimage(`http://localhost:3333/uploads/artist_photos/${res.data.album_photo}`);
                    ...
                    <div style={{
                        ...
                        {artistdata && (
                            <div style={{
                                ...
                                <h1 style={{ fontSize: "5rem", position: 'relative', zIndex: "2" }}>{artistdata.name}</h1>
                                <p style={{ position: 'relative', zIndex: "2" }}>{countartistsongs} songs</p>
                            </div>
                        )}
                    </div>
