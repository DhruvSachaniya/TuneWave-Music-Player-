import { Body, Controller, Delete, Get, HttpException, HttpStatus, Post, Query, Request, UseGuards } from '@nestjs/common';
    ...
    async getMusicByIds(
        ...
        try {
            ...
            if (Array.isArray(musicIds)) {
                ...
                throw new HttpException("Invalid input: musicIds must be an array", HttpStatus.BAD_REQUEST);
            }
        } catch (error) {
